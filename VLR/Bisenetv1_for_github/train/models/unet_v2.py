...
class UNet_v2(nn.Module):
    ...
    def __init__(self, n_classes=2, mode='train',in_channels=3, init_features=32):
        ...
        self.bottleneck = UNet_v2._block(features * 8, features * 16, name="bottleneck")

        self.upconv4 = nn.ConvTranspose2d(
            features * 16, features * 8, kernel_size=2, stride=2
        )
        self.decoder4 = UNet_v2._block((features * 8) * 2, features * 8, name="dec4")
        self.upconv3 = nn.ConvTranspose2d(
            features * 8, features * 4, kernel_size=1, stride=1
        )
        self.decoder3 = UNet_v2._block((features * 4) * 2, features * 4, name="dec3")
        self.upconv2 = nn.ConvTranspose2d(
            features * 4, features * 2, kernel_size=1, stride=1
        )
        self.decoder2 = UNet_v2._block((features * 2) * 2, features * 2, name="dec2")
    ...
    @staticmethod
    def _block(in_channels, features, name, dilation=1):
